...
PCA9685::PCA9685(int address, char bus) {
...
{
    ROS_INFO("PCA9685->I2C: device starting");
    ...
    if (kI2CFileDescriptor < 0) {
        ...
        error = errno ;
        ROS_ERROR("PCA9685->I2C: Failed to open bus '%s': %i-%s", fileNameBuffer, errno, strerror(errno));
        return false ;
    }
    ...
    ROS_INFO("PCA9685->I2C: device open bus");
